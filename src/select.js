            ...
            function($document, uiSelectConfig, uiSelectMinErr, $compile, $parse) {
                ...
                return {
                    ...
                    templateUrl: function(tElement, tAttrs) {
                        ...
                        var path  = tAttrs.path  || uiSelectConfig.path;
                        return path + theme + (angular.isDefined(tAttrs.multiple) ? '/select-multiple.tpl.html' : '/select.tpl.html');
                    },
                    replace: true,
                    transclude: true,
            ...
            function(uiSelectConfig, RepeatParser, uiSelectMinErr, $compile) {
                ...
                return {
                    ...
                    templateUrl: function(tElement) {
                        ...
                        var path  = tElement.parent().attr('path')  || uiSelectConfig.path;
                        return path + theme + '/choices.tpl.html';
                    },
        ...
        .directive('uiSelectMatch', ['uiSelectConfig', function(uiSelectConfig) {
            return {
                ...
                templateUrl: function(tElement) {
                    ...
                    return path + theme + (multi ? '/match-multiple.tpl.html' : '/match.tpl.html');
                },
